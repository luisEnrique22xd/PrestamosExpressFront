...
export default function PagosPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-4 md:py-10 animate-in fade-in duration-500">      <div className="bg-white p-6 md:p-10 rounded-3xl md:rounded-[3rem] shadow-sm border border-slate-100 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="text-2xl md:text-3xl font-black text-slate-800 mb-2 italic tracking-tighter">Caja de Cobranza</h2>        <p className="text-slate-400 text-sm mb-10 font-medium italic">Gestión de Abonos y Recuperación de Capital</p>
